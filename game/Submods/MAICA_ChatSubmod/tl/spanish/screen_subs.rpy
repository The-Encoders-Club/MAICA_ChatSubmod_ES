...
translate spanish strings:
    ...
    new "{size=-10}Atención: solo los parámetros marcados tendrán efecto, los demás mantendrán los valores por defecto del servidor"
    ...
    new "Semilla de generación. Normalmente es un factor menor y aleatorio"
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:287
    old "Advanced settings"
    new "Ajustes avanzados"
    ...
    new "Introduce el correo de tu cuenta DCC"
    ...
    new "Introduce el nombre de usuario de tu cuenta DCC"
    ...
    new "> Cambiar a inicio de sesión con usuario"
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:427
    old "> Use email instead"
    new "> Cambiar a inicio de sesión con correo electrónico"
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:434
    old "Enter password"
    new "Introduce la contraseña"
    ...
    new "Selecciona la única página más relacionada, ignorando el rango de muestreo. Es rápido ya que no realiza una búsqueda recursiva.\n"
    ...
    new "Selecciona una página al azar de entre varias relacionadas. Es rápido ya que no realiza una búsqueda recursiva.\n"
    ...
    new "Selecciona la categoría más relacionada y luego busca de forma recursiva en páginas y subcategorías. Es lento.\n"
    ...
    new "Selecciona una categoría al azar de entre varias relacionadas y luego busca de forma recursiva en páginas y subcategorías. Es lento.\n"
    ...
    new "Busca de forma recursiva en páginas, categorías y subcategorías relacionadas. Es lento.\n"
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:805
    old "Integrated | Change BGM{#maica_trigger_screen}"
    new "Integrado | Cambiar música de fondo "
    ...
    new "mplus-1mn | Monoespaciado por defecto {size=-10}*Compatibilidad limitada con caracteres chinos{/size}"
...
translate spanish strings:
    ...
    new "Por favor, introduzca su ubicación geográfica."
...
translate spanish strings:
    ...
    new "La realidad aquí no es estable. Reiniciar la sesión podría ayudarla a recomponerse y a pensar con más claridad."
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:42
    old "You decide, but things may go worse if you don't."
    new "Tú decides, pero si no la reinicias, lo más probable es que las cosas empeoren."
    # game/Submods/MAICA_ChatSubmod/screen_subs.rpy:47
    old "Don't embarrass her... nor let her look at the window!"
    new "No dejes que pase vergüenza... ¡y tampoco dejes que mire por la ventana!"
...
translate spanish strings:
    ...
    new "El idioma en el que estás escribiendo parece no coincidir con el idioma objetivo de MAICA."
    ...
    new "Tu idioma objetivo actual de MAICA está configurado en '[current_lang]'. Por favor, ajusta tu configuración para chatear en otro idioma."
