...
translate spanish strings:
    ...
    new "Integrado | Cambiar clima {size=-5}* No disponible en el Bosque Celestial"
    # game/Submods/MAICA_ChatSubmod/trigger.rpy:218
    old "Integrated | Hug"
    new "Integrado | Abrazo"
...
translate spanish strings:
    ...
    new "Integrado | Ajustar afecto, rango de 0 a 3 por vez * 10 min de tiempo de espera"
    # game/Submods/MAICA_ChatSubmod/trigger.rpy:152
    old "Integrated | Change weather * Not effective in Heaven Forest"
    new "Integrado | Cambiar clima * No funciona en el Bosque Celestial"
    # game/Submods/MAICA_ChatSubmod/trigger.rpy:229
    old "Integrated | Backup persistent * Extra Plus Submod required"
    new "Integrado | Copia de seguridad del progreso * Requiere el submod Extra Plus"
...
translate spanish strings:
    ...
    new "Integrado | Quitar accesorios"
...
translate spanish strings:
    ...
    new "Integrado | Alerta de degradación del chat (Receptor)"
translate spanish strings:
